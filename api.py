...
# Configuration
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'postgresql://neondb_owner:npg_tcPVq5kdHbh7@ep-spring-river-aiq267h9-pooler.c-4.us-east-1.aws.neon.tech/tawam?sslmode=require&channel_binding=require')
